const pairGame = function () {
    ...
    function generateCard(index) {
        if (settings.cardContent === 'colors') {
            ...
            return `<div class="flip-container"><div class="flipper ${DOM.card} js-card-no-click" data-id="${index + 100}"><div class="front"></div><div class="back" style="background-image: url(../images/${cardsResources.cardsImages[index]})"></div></div></div>`
        }
    };
